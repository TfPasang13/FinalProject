...
namespace PasangT_SMS.web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            ICrudService<StudentInfo> studentInfo,
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //var studentInfoList = await _studentInfo.GetAllAsync();
            //StudentInfos = studentInfoList;

            //StudentInfoList = new SelectList(studentInfoList, "Id", "Name");
